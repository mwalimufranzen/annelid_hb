...
# You don't need to import find_start_codon, it's already defined here
...
def excise_exons_introns_to_fasta(exon_positions, target_seq):
    ...
    for idx in range(1, len(exon_positions)):
        ...
        if exon_list[idx][2] == '+':
            ...
            intron_end = exon_list[idx-1][1] + 1  # End of previous exon + 1
            intron_start = exon_list[idx][0] - 1  # Start of next exon - 1
